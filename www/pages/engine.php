...
// Фильтруем только двигатели
$parts = array_filter($parts, function ($part) {
    return isset($part['partType']) && $part['partType'] === 'Двигатель';
});
        ...
        <?php else: ?>
            ...
            <?php foreach ($parts as $part): ?>
                ...
                <div class="card"
                    ...
                    data-count="<?= htmlspecialchars($part['count']) ?> шт"
                    ...
                    <form action="../controllers/autoPartController.php" method="post">
                        ...
                        <input type="hidden" name="return" value="/www/pages/engine.php">
